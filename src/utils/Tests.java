...
public abstract class Tests {
    ...
    public enum TestsEnum {
        ...
        RAIN("rain", getRainMatrix50x50(), "Дождь"),
        CHESS("chess", getChessMatrix50x50(), "Шахматы"),
        SQUARE("square", getSquareMatrix50x50(), "Квадраты"),
        X_BLACK("x_black", getXBlackMatrix50x50(), "Черные кресты"),
        X_WHITE("x_white", getXWhiteMatrix50x50(), "Белые кресты"),
        X_SMALL_WHITE("x_small_white", getXSmallWhiteMatrix50x50(), "Маленькие белые кресты"),
        H_MATRIX("h_matrix", getHMatrix50x50(), "Рисунки в форме H"),
        SNAKE_MATRIX("snake", getSnakeMatrix50x50(), "Змейка");

        private String title;
        private ArrayList<ArrayList<Point>> table;
        private String description;

        TestsEnum(String title, ArrayList<ArrayList<Point>> table, String description) {
            this.table = table;
            this.title = title;
        ...
        public ArrayList<ArrayList<Point>> getTable() {
            return table;
        }
